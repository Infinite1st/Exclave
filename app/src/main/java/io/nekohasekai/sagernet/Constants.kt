...
object Key {
    ...
    const val SERVER_AMNEZIAWG_JC = "serverAmneziaWGJc"
    const val SERVER_AMNEZIAWG_JMIN = "serverAmneziaWGJmin"
    const val SERVER_AMNEZIAWG_JMAX = "serverAmneziaWGJmax"
    const val SERVER_AMNEZIAWG_S1 = "serverAmneziaWGS1"
    const val SERVER_AMNEZIAWG_S2 = "serverAmneziaWGS2"
    const val SERVER_AMNEZIAWG_S3 = "serverAmneziaWGS3"
    const val SERVER_AMNEZIAWG_S4 = "serverAmneziaWGS4"
    const val SERVER_AMNEZIAWG_H1 = "serverAmneziaWGH1"
    const val SERVER_AMNEZIAWG_H2 = "serverAmneziaWGH2"
    const val SERVER_AMNEZIAWG_H3 = "serverAmneziaWGH3"
    const val SERVER_AMNEZIAWG_H4 = "serverAmneziaWGH4"
    const val SERVER_AMNEZIAWG_I1 = "serverAmneziaWGI1"
    const val SERVER_AMNEZIAWG_I2 = "serverAmneziaWGI2"
    const val SERVER_AMNEZIAWG_I3 = "serverAmneziaWGI3"
    const val SERVER_AMNEZIAWG_I4 = "serverAmneziaWGI4"
    const val SERVER_AMNEZIAWG_I5 = "serverAmneziaWGI5"
    const val SERVER_AMNEZIAWG_HEADER_PROTECTION_KEY = "serverAmneziaWGHeaderProtectionKey"
